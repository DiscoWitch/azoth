...
function Entity:setMaterialCount(matname, amount)
    if type(matname) == "number" then matname = CellFactory_GetName(matname) end
    AddMaterialInventoryMaterial(self.__id, matname, amount)
end

...
table.insert(actions, {id = "AZOTH_TURRET", name = "Spell turret",
                       ...
                       type = ACTION_TYPE_STATIC_PROJECTILE, spawn_level = "0,1,2,3,4,5,6,10",
                       spawn_probability = "0,0,0,0.1,0.1,0.1,0.2,0.3", price = 500, mana = 300,
                       ai_never_uses = true, max_uses = -1, action = function()
...
table.insert(actions, {id = "AZOTH_TURRET_PATIENT", name = "Calculating Spell Turret",

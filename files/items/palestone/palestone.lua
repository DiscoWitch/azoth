...
local detector = EntityLoad("mods/azoth/files/items/palestone/palestone_projectile.xml",
...
if mat then
    ...
    for k, v in self.ParticleEmitterComponent:ipairs() do v.color = color end

...
-- ModLuaFileAppend( "data/scripts/gun/gun_actions.lua", "mods/azoth/files/actions.lua" ) -- Basically dofile("mods/azoth/files/actions.lua") will appear at the end of gun_actions.lua
...
-- ModLuaFileAppend( "data/scripts/items/potion.lua", "mods/azoth/files/potion_appends.lua" )
